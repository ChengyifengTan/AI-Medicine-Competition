...
class LVLMConfig(PretrainedConfig):
    def __init__(self, model_arguments=None, **kwargs):
        if model_arguments is not None:
            print("=== Debug: Entered model_arguments block")
            ...
            # modules
            print(f'===self.llm_config: {LLM_FACTORY[self.llm_type][0](model_arguments)}')
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        print(f'==model_arguments.encoder_image_type={model_arguments.encoder_image_type}')
